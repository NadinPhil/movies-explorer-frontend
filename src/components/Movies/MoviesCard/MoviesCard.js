    ...
    return (
        <section className="card">
            <li className="elements-grid__item">
                ...
                {(props.location === "/movies") && (<button aria-label="Флаг" type="button" className={cardLikeButtonClassName} onClick={handleLikeClick}></button>) }
                {(props.location === "/saved-movies") && (<button aria-label="Флаг" type="button" className="elements-grid__flag_delete" onClick={handleDeleteClick}></button>) }
