            ...
            <div className="myself__info">
                <div className="myself__text">
                    ...
                    <div className="myself__links">
                        <a href="https://vk.com/piupiu_piu" target="_blank" className="myself__link">VK</a>
                        <a href="https://github.com/NadinPhil" target="_blank" className="myself__link">Github</a>
                    </div>
                </div>
